...
import 'package:cine_one/Cinema/buy_ticket_page.dart';
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        Color(0xff22222C),
                        Color(0xff22222C).withOpacity(.8),
          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                TextOne(text: 'Sinopsis', color: Colors.white, fontWeight: FontWeight.bold, fontSize: 30),
                SizedBox(height: 15.0),
                Container(
                  width: size.width * .9,
                  child: Wrap(
                    children: [
                      TextOne(text: movieModel.description, color: Colors.white, maxLines: 6, textAlign: TextAlign.center )
                    ],
                  ),
                ),
              ],
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: TextOne(text: 'Comprar entrada', fontWeight: FontWeight.bold),
              ),
            ),
          ),
