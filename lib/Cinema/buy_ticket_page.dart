...
import 'package:cine_one/Cinema/Helpers/painter.dart';
import 'package:cine_one/Cinema/Models/armchairs_model.dart';
import 'package:cine_one/Cinema/Models/datetime_model.dart';
import 'package:cine_one/Cinema/Widgets/Seats.dart';
            ...
            child: Container(
              decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        Color(0xff22222C),
                        Color(0xff22222C).withOpacity(.9),
                        Color(0xff22222C).withOpacity(.1),
                      ]
                    ),
                  ),
              child: ClipRRect(
                child: BackdropFilter(
                  ...
                  child: Container(
                    color: Color(0xff22222C).withOpacity(0.1),
                  ),
                ),
              ),
            ),
              ...
              child: IconButton(
                ...
                icon: Row(
                  children: [
                    ...
                    SizedBox(width: 20.0),
                    TextOne(text: titleMovie, color: Colors.white, fontWeight: FontWeight.bold )
                  ],
                )
              ),
            )
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  PainterScreenMovie(),
                  TextOne(text: 'Pantalla', color: Colors.white, fontWeight: FontWeight.w500),
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: TextOne(text: 'Comprar entrada  \S/.15.00', fontWeight: FontWeight.bold),
              ),
            ),
          ),
        ...
        child: BlocBuilder<CinemaBloc, CinemaState>(
          builder: (context, state) => 
            Container(
              ...
              child: TextOne(text: time, color: Colors.white, fontSize: 16)
            ),
        ),
      ),
    );
          ...
          builder: (context, state) => 
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10.0),
                TextOne(text: date.day, color: Colors.white, fontSize: 17),
                SizedBox(height: 5.0),
                TextOne(text: date.number, color: Colors.white, fontSize: 30),
              ],
            ),
          ),
        ),
